package com.example.hui.datastorage;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void spWrite(View v){
       ...
       SharedPreferences.Editor editor=user.edit();
        ...
        editor.commit();
        Toast.makeText(this,"sharePregerencees写入成功",Toast.LENGTH_LONG).show();
    }
    public void spRead(View v){
        SharedPreferences user=getSharedPreferences("user",MODE_PRIVATE);
        String accout=user.getString("accout","木有这个键值");
        String pass=user.getString("pass","木有这个键值");
        tv1.setText("账号："+accout+"\n"+"密码："+pass);
        Toast.makeText(this,"sharePregerencees读取成功",Toast.LENGTH_LONG).show();
    }
    ...
    public void SDWrite(View v){
        ...
        String filename=sdCardRoot+"/user.txt";
